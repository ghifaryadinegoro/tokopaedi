export default function HomeFooter() {
  return (
    <footer className="mt-10 border-t-2  font-sans tracking-wide">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 px-10 py-4">
        <div>
          <h4 className="text-base font-semibold mb-4 text-black">About Us</h4>
          <p className="text-gray-500 text-sm text-justify">
            Tokopaedi is your go-to e-commerce platform, where you can find
            everything you need, anytime, anywhere. With our commitment to
            &quot;Selalu Ada, Selalu Bisa&quot; we make online shopping easy,
            reliable, and enjoyable. Discover a wide range of products and
            experience seamless shopping with Tokopaedi.
          </p>
        </div>
        <div>
          <h4 className="text-base font-semibold mb-4 text-black">
            Guide and Help
          </h4>
          <ul className="space-y-4">
            <li>
              <a
                ...
                className="text-gray-500 hover:text-[#00aa5b] text-sm"
              >
                Tokopaedi Care
              </a>
            </li>
        ...
        <div className="space-y-4">
          ...
          <p className="text-gray-500 text-sm">City, State, Country</p>
          <p className="text-gray-500 text-sm">contact@example.com</p>
          <p className="text-gray-500 text-sm">+1 234 567 890</p>
        </div>
        <div>
          <h4 className="text-base font-semibold mb-4 text-black">Follow Us</h4>
